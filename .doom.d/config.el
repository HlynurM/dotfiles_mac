...
(setq user-full-name "Hlynur Magnusson"
      user-mail-address "hlynur.magnus@gmail.com")
...
;;       doom-variable-pitch-font (font-spec :family "Source Code Pro Semibold" :size 14))
...
;; Ask what window to choose after split
...
;; Adding Arrows to influence window rotation as an option
;; Window rotation is nice, and can be found under SPC w r and SPC w R.
;; Layout rotation is also nice though. Let’s stash this under SPC w SPC,
;; inspired by Tmux’s use of C-b SPC to rotate windows.
